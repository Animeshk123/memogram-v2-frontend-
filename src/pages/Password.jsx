...
export default function Password({setProgress}){
  ...
  return (
    <>
      ...
      <p className="text-center text-sm text-gray-500 mt-3">Enter A Email Where We Will Send A Password Reset Link To Your Email</p>
